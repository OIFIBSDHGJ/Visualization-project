...
(function() {
    ...
    option = {
        ...
        series: [{
                ...
                type: 'line',
                smooth: true,
                data: [20, 40, 101, 134, 90, 230, 210, 230, 120, 230, 210, 120]
            },
            {
                name: '新增游客',
                type: 'line',
...
(function() {
    ...
    var option = {
        ...
        series: [{
                ...
                showSymbol: false,
                data: [30, 40, 30, 40, 30, 40, 30, 60, 120, 40, 30, 40, 30, 40, 30, 40, 70, 60, 20, 40, 30, 40, 30, 40, 30, 40, 20, 60, 50, 40],
                lineStyle: {
                    color: '#0184d5',
                    width: 2
                }
            },
            {
                ...
                showSymbol: false,
                data: [130, 10, 20, 40, 30, 40, 80, 60, 20, 40, 90, 40, 20, 140, 30, 40, 130, 20, 20, 40, 80, 70, 30, 40, 30, 120, 20, 10, 50, 20]
            }
        ]
    };
    myECharts.setOption(option);
...
(function() {
    ...
    var option = {
        ...
        color: ['#065aab', '#066eab', '#0582ab', '#0696ab', '#06a0ab'],
        legend: {
            bottom: '5%',
            left: 'center',
            itemWidth: 10,
...
(function() {
    ...
    var XAData = [
        ...
        [{ name: '合肥' }, { name: '石家庄', value: 100 }],
        [{ name: '鄂尔多斯' }, { name: '合肥', value: 100 }],
        [{ name: '拉萨' }, { name: '合肥', value: 100 }],
    ];
